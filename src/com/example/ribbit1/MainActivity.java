	...
	protected DialogInterface.OnClickListener mDialogListener = 
		...
		public void onClick(DialogInterface dialog, int which) {
			switch(which){
				...
				case 2: //choose picture
					...
					break;
				case 3: //chose video
					Intent chooseVedioIntent = new Intent(Intent.ACTION_GET_CONTENT);
					chooseVedioIntent.setType("video/*");
					Toast.makeText(MainActivity.this, R.string.video_file_size_warning, Toast.LENGTH_LONG).show();
					startActivityForResult(chooseVedioIntent, PICK_VIDEO_REQUEST);
					break;
			}
		...
		private Uri getOutputMediaFileUri(int mediaType) {
			...
			if(isExternalStorageAvailable()){
				...
				//1.get the external storate directory
				String appName = MainActivity.this.getString(R.string.app_name);
				File mediaStorageDir = new File(
						Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES),
						appName);
				//2. create our sudirectory
